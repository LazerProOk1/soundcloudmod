        ...
        <div className="flex-1 min-w-0 flex flex-col justify-center">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {track.access === 'blocked' && (
              <span className="shrink-0 text-[9px] font-bold text-amber-400 bg-amber-400/10 border border-amber-400/30 uppercase tracking-wide px-1.5 py-0.5 rounded-full">
                Go+
              </span>
            )}
          </div>
